...
gcloud run jobs deploy eink-update \
    ...
    --max-retries 1 \
    --project ${PROJ} \
    --set-env-vars BUCKET_NAME=${BUCKET_NAME},FEED_ID=${FEED_ID},SCHILDKROETE_USERNAME=${SCHILDKROETE_USERNAME},SCHILDKROETE_PASSWORD=${SCHILDKROETE_PASSWORD},EVENTS_GIST_URL=${EVENTS_GIST_URL}
